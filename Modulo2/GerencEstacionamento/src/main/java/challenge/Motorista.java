...
public class Motorista {
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withIdade(int idade) {
            verificaNegativo(idade);
            this.idade = idade;
            return this;
        }

        public MotoristaBuilder withPontos(int pontos) {
            verificaNegativo(pontos);
            this.pontos = pontos;
            return this;
        }
        ...
        public void validarMotorista() {
            boolean validarHabilitacao = this.habilitacao.isEmpty() || this.habilitacao == null;
            boolean validarNome = this.nome.isEmpty() || this.nome == null;
            if (validarHabilitacao || validarNome)
                throw new NullPointerException();
        }
        
        private void verificaNegativo(int x) {
            if( x < 0 )
